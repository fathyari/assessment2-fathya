        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            while ($row=$result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?= $row['jumlah_ip']; ?></td>
                                    <td class="text-center"><?= $row['semester']; ?></td>
                                    <td class="text-center">
                                        <a href="delete_ip.php?id_ip=<?= $row['id']; ?>" onclick="return confirm('Do you want to delete data?')">
                                            <i class="fas fa-trash mr-3"></i>
                                        </a>
                                        <a href="edit_ip.php?id_ip=<?=$row['id'] ?>">
                ...
                <button type="button" class="btn btn-success btn-sm" >
                    <a href="add_ip.php" class="text-white">
